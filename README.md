...
> In some complex custom cases, you may prefer to use the OpenStack Heat template for the VAP installation. Check the detailed [VAP Cluster Deployment with OpenStack Heat](https://github.com/virtuozzo/vap-installer-on-vhi/tree/8.14-3/installer) guide.
