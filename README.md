...
```
wget https://vap-images.virtuozzo.dev/vap-images/latest/vap-8-11-2.qcow2
```
- Create an image:
```
vinfra service compute image create vap-8-11-2 --disk-format qcow2 --container-format bare --file vap-8-11-2.qcow2 --public --wait
```
